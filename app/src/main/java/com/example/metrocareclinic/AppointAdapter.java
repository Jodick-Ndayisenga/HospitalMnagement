...
public class AppointAdapter extends RecyclerView.Adapter<AppointAdapter.ViewHolder>  {
    ...
    public AppointAdapter(Context context, ArrayList<Appointment> arrayList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_list_appointments, parent, false);
