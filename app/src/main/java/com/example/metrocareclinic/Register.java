...
public class Register extends AppCompatActivity {
    TextInputEditText firstName, lastName, username, dob, email, residence, password, confirmPassword;
                                                        ...
                                                        if(!pwd.equals(cpwd)){
                                                            ...
                                                            db.collection("users").add(user).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                                                ...
                                                                public void onFailure(@NonNull Exception e) {
                                                                    Toast.makeText(Register.this, "There was an error while adding user", Toast.LENGTH_SHORT).show();
                                                                }
                                                            });
                                                        }
